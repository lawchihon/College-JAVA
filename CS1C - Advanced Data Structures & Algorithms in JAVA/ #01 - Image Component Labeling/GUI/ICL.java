...
public class ICL extends JFrame implements Runnable {
	...
	private static final int initialDimension = 10; // Initial Time for an
													// activity
	...
	public ICL() {
		...
		chooseDimensionText = new JTextField("" + initialDimension, 5);
	...
	private class theChoice implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			if (source == labelComponents) {
				/*
				 * This is where the call for the labelBreadth and labelDepth of
				 * the ICLLogic class is going to occur
				 */
				canvasDepthFirst.labelDepth();
				canvasBreadthFirst.labelBreadth();
			}
