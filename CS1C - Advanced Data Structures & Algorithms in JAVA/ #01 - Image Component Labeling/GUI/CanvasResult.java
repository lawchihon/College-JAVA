...
public class CanvasResult extends JPanel {
	...
	private class CanvasRect extends Canvas {
		...
		/*
		 * This method is used to paint the squares generated in ICLLogic. It
		 * also calls the methods labelbreadth and labelDepth. These 2 methods
		 * will then label the graph.
		 */
