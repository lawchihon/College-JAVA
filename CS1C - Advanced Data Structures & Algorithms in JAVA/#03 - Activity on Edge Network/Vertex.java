...
Description: This class simulate the event in an activity network
 ****************************************************************/
...
public class Vertex {
	...
	public void draw(Graphics g) {
		...
		g.drawOval(vertexX - Diameter / 2, vertexY - Diameter / 2, Diameter,
				Diameter);
	...
	public boolean isInclude(int x, int y) {
		return ((Diameter / 2 > Math.abs((vertexX - x))) && (Diameter / 2 > Math
				.abs((vertexY - y))));
