...
Description: This class simulate the activity in an activity
			 network
 *****************************************************************/
import java.awt.*;
...
public class Edge {
	...
	/*
	 * it draws an activity from the center of two events it prints the time and
	 * the name of the activity on the medium of the line
	 */
	public void draw(Graphics g) {
		...
		g.drawString("T" + ID + " " + activityTime,
				beginX + Math.abs(startX - endX) / 2,
				beginY + Math.abs(startY - endY) / 2);
	...
	public boolean getCritical() {
		return (vertexTwo.getLatestEvent() - getTime()) == vertexOne
				.getEarliestEvent();
	}
